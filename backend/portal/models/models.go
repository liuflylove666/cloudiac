...
func Init(migrate bool) {
	...
	autoMigrate(&CmdbRiskRuleConfig{}, sess)
	...
	autoMigrate(&NotificationDelivery{}, sess)
	autoMigrate(&NotificationTemplate{}, sess)
	autoMigrate(&NotificationTemplateVersion{}, sess)
	autoMigrate(&SystemCfg{}, sess)
	autoMigrate(&CloudAccount{}, sess)
	autoMigrate(&CloudAccountRegion{}, sess)
	autoMigrate(&CloudAccountPermission{}, sess)
	autoMigrate(&CloudSyncPolicy{}, sess)
	autoMigrate(&CloudOperation{}, sess)
	autoMigrate(&CloudOperationStep{}, sess)
	autoMigrate(&CloudOperationAudit{}, sess)
	autoMigrate(&CloudRiskFinding{}, sess)
	autoMigrate(&CloudEvent{}, sess)
	autoMigrate(&CloudCostRecord{}, sess)
	autoMigrate(&CloudCostSyncTask{}, sess)
	autoMigrate(&CloudCostSyncTaskLog{}, sess)
	autoMigrate(&CloudCostSyncSchedule{}, sess)
	autoMigrate(&CloudCostInsight{}, sess)
	autoMigrate(&CloudBudget{}, sess)
	autoMigrate(&CloudWebhook{}, sess)
	autoMigrate(&CloudWebhookDelivery{}, sess)
	autoMigrate(&CloudWebhookDeliveryQueue{}, sess)
	autoMigrate(&CloudWebhookDeadLetter{}, sess)
	autoMigrate(&CloudItsmConfig{}, sess)
	autoMigrate(&CloudItsmTicket{}, sess)
