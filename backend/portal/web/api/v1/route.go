...
func Register(g *gin.RouterGroup) {
	...
	g.POST("/cloud/itsm/callbacks/:connectorId/status", w(handlers.CloudItsm{}.StatusCallback))
	g.POST("/cloud/itsm/callbacks/:connectorId/gitops-gate", w(handlers.CloudItsm{}.GitOpsGateCallback))
	...
	g.GET("/cloud/assets/permissions", ac("orgs", "read"), w(handlers.CloudAsset{}.AssetPermissions))
	g.GET("/cloud/assets/governance-report", ac("orgs", "read"), w(handlers.CloudAsset{}.AssetGovernanceReport))
	...
	g.GET("/cloud/assets/import-template", ac("orgs", "read"), w(handlers.CloudAsset{}.ImportTemplate))
	...
	g.GET("/cloud/assets/:id/relations", ac("orgs", "read"), w(handlers.CloudAsset{}.AssetRelations))
	...
	g.POST("/cloud/risks/:id/remediation-ticket", ac("orgs", "read"), w(handlers.CloudRisk{}.CreateRemediationTicket))
	g.POST("/cloud/risks/:id/recommendations/adopt", ac("orgs", "read"), w(handlers.CloudRisk{}.AdoptRecommendation))
	...
	g.GET("/cloud/itsm/catalog-policies/:key/history", ac("orgs", "read"), w(handlers.CloudItsm{}.CatalogPolicyHistory))
	g.PUT("/cloud/itsm/catalog-policies/:key", ac("orgs", "read"), w(handlers.CloudItsm{}.UpdateCatalogPolicy))
	g.POST("/cloud/itsm/self-service-tickets", ac("orgs", "read"), w(handlers.CloudItsm{}.CreateSelfServiceTicket))
	g.POST("/cloud/itsm/tickets/sync-due", ac("orgs", "read"), w(handlers.CloudItsm{}.SyncDueTicketStatuses))
	g.POST("/cloud/itsm/tickets/retry-failed", ac("orgs", "read"), w(handlers.CloudItsm{}.RetryDueTicketSubmissions))
	g.GET("/cloud/itsm/tickets/retry-queue/summary", ac("orgs", "read"), w(handlers.CloudItsm{}.SubmitRetryQueueSummary))
	g.GET("/cloud/itsm/tickets/retry-queue/report", ac("orgs", "read"), w(handlers.CloudItsm{}.SubmitRetryQueueReport))
	g.GET("/cloud/itsm/tickets/retry-queue", ac("orgs", "read"), w(handlers.CloudItsm{}.SearchSubmitRetryQueue))
	g.POST("/cloud/itsm/tickets/retry-queue/dead-letters/action", ac("orgs", "read"), w(handlers.CloudItsm{}.BatchDeadLetterAction))
	g.POST("/cloud/itsm/tickets/retry-queue/dead-letters/approval", ac("orgs", "read"), w(handlers.CloudItsm{}.CreateDeadLetterApproval))
	g.GET("/cloud/itsm/tickets", ac("orgs", "read"), w(handlers.CloudItsm{}.SearchTickets))
	g.POST("/cloud/itsm/tickets/:id/replay-submit", ac("orgs", "read"), w(handlers.CloudItsm{}.ReplayTicketSubmission))
	...
	g.GET("/cmdb/assets/permissions", ac("orgs", "read"), w(handlers.Cmdb{}.AssetPermissions))
	g.GET("/cmdb/assets/governance-report", ac("orgs", "read"), w(handlers.Cmdb{}.AssetGovernanceReport))
	...
	g.GET("/cmdb/assets/import-template", ac("orgs", "read"), w(handlers.Cmdb{}.ImportTemplate))
	...
	g.GET("/cmdb/risk-rules", ac("orgs", "read"), w(handlers.Cmdb{}.RiskRuleConfig))
	g.PUT("/cmdb/risk-rules", ac("orgs", "read"), w(handlers.Cmdb{}.UpdateRiskRuleConfig))
	g.PUT("/cmdb/assets/ownership", ac("orgs", "read"), w(handlers.Cmdb{}.BatchUpdateAssetOwnership))
	g.GET("/cmdb/assets/:id/relations", ac("orgs", "read"), w(handlers.Cmdb{}.AssetRelations))
